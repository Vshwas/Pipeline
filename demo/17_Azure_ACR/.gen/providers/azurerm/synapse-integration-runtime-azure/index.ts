// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/synapse_integration_runtime_azure
...
export class SynapseIntegrationRuntimeAzure extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SynapseIntegrationRuntimeAzure that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/synapse_integration_runtime_azure#import import section} in the documentation of this resource for the id to use
