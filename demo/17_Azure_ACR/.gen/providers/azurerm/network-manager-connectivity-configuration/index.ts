// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/network_manager_connectivity_configuration
...
export class NetworkManagerConnectivityConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkManagerConnectivityConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/network_manager_connectivity_configuration#import import section} in the documentation of this resource for the id to use
