// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/cognitive_account_rai_blocklist
...
export class CognitiveAccountRaiBlocklist extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CognitiveAccountRaiBlocklist that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/cognitive_account_rai_blocklist#import import section} in the documentation of this resource for the id to use
