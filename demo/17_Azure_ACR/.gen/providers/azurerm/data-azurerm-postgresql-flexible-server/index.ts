// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/postgresql_flexible_server
...
export interface DataAzurermPostgresqlFlexibleServerHighAvailability {
}

export function dataAzurermPostgresqlFlexibleServerHighAvailabilityToTerraform(struct?: DataAzurermPostgresqlFlexibleServerHighAvailability): any {
...
export function dataAzurermPostgresqlFlexibleServerHighAvailabilityToHclTerraform(struct?: DataAzurermPostgresqlFlexibleServerHighAvailability): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAzurermPostgresqlFlexibleServerHighAvailabilityOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermPostgresqlFlexibleServerHighAvailability | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermPostgresqlFlexibleServerHighAvailability | undefined) {
    if (value === undefined) {
...
export class DataAzurermPostgresqlFlexibleServerHighAvailabilityList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAzurermPostgresqlFlexibleServerHighAvailabilityOutputReference {
    return new DataAzurermPostgresqlFlexibleServerHighAvailabilityOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAzurermPostgresqlFlexibleServer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermPostgresqlFlexibleServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/postgresql_flexible_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _highAvailability = new DataAzurermPostgresqlFlexibleServerHighAvailabilityList(this, "high_availability", false);
