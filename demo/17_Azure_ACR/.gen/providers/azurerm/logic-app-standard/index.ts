...
export class LogicAppStandard extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogicAppStandard that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/logic_app_standard#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: LogicAppStandardConfig) {
    ...
    this._scmPublishBasicAuthenticationEnabled = config.scmPublishBasicAuthenticationEnabled;
    ...
    this._vnetContentShareEnabled = config.vnetContentShareEnabled;
  ...
  public resetScmPublishBasicAuthenticationEnabled() {
    this._scmPublishBasicAuthenticationEnabled = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get scmPublishBasicAuthenticationEnabledInput() {
    return this._scmPublishBasicAuthenticationEnabled;
  }
  ...
  public resetVnetContentShareEnabled() {
    this._vnetContentShareEnabled = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get vnetContentShareEnabledInput() {
    return this._vnetContentShareEnabled;
  }
