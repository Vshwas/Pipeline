// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/site_recovery_vmware_replication_policy
...
export class SiteRecoveryVmwareReplicationPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SiteRecoveryVmwareReplicationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/site_recovery_vmware_replication_policy#import import section} in the documentation of this resource for the id to use
