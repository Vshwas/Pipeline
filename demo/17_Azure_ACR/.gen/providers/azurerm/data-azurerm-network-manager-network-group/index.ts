// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/network_manager_network_group
...
export class DataAzurermNetworkManagerNetworkGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermNetworkManagerNetworkGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/network_manager_network_group#import import section} in the documentation of this resource for the id to use
