...
export class DataAzurermKubernetesClusterBootstrapProfileOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermKubernetesClusterBootstrapProfileList extends cdktf.ComplexList {
