// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/shared_image_versions
...
export class DataAzurermSharedImageVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermSharedImageVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/shared_image_versions#import import section} in the documentation of this resource for the id to use
