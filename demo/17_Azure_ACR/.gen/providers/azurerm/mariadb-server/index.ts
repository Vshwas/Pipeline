// https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server
...
export interface MariadbServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#administrator_login MariadbServer#administrator_login}
  */
  readonly administratorLogin: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#administrator_login_password MariadbServer#administrator_login_password}
  */
  readonly administratorLoginPassword: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#id MariadbServer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#location MariadbServer#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#name MariadbServer#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#resource_group_name MariadbServer#resource_group_name}
  */
  readonly resourceGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#sku_name MariadbServer#sku_name}
  */
  readonly skuName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#ssl_enforcement MariadbServer#ssl_enforcement}
  */
  readonly sslEnforcement: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#tags MariadbServer#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#version MariadbServer#version}
  */
  readonly version: string;
  /**
  * storage_profile block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#storage_profile MariadbServer#storage_profile}
  */
  readonly storageProfile: MariadbServerStorageProfile;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#timeouts MariadbServer#timeouts}
  */
  readonly timeouts?: MariadbServerTimeouts;
}
export interface MariadbServerStorageProfile {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#auto_grow MariadbServer#auto_grow}
  */
  readonly autoGrow?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#backup_retention_days MariadbServer#backup_retention_days}
  */
  readonly backupRetentionDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#geo_redundant_backup MariadbServer#geo_redundant_backup}
  */
  readonly geoRedundantBackup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#storage_mb MariadbServer#storage_mb}
  */
...
export function mariadbServerStorageProfileToHclTerraform(struct?: MariadbServerStorageProfileOutputReference | MariadbServerStorageProfile): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface MariadbServerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#create MariadbServer#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#delete MariadbServer#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#read MariadbServer#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#update MariadbServer#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server azurerm_mariadb_server}
*/
export class MariadbServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MariadbServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.0.0/docs/resources/mariadb_server azurerm_mariadb_server} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      storage_profile: {
        value: mariadbServerStorageProfileToHclTerraform(this._storageProfile.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "MariadbServerStorageProfileList",
      },
      timeouts: {
