// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/kubernetes_cluster_node_pool
...
export class DataAzurermKubernetesClusterNodePool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermKubernetesClusterNodePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/kubernetes_cluster_node_pool#import import section} in the documentation of this resource for the id to use
