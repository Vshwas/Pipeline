// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/virtual_hub_connection
...
export class DataAzurermVirtualHubConnectionRoutingOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // static_vnet_propagate_static_routes_enabled - computed: true, optional: false, required: false
...
export class DataAzurermVirtualHubConnection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermVirtualHubConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/virtual_hub_connection#import import section} in the documentation of this resource for the id to use
