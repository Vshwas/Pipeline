// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/vpn_server_configuration
...
export class DataAzurermVpnServerConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermVpnServerConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/vpn_server_configuration#import import section} in the documentation of this resource for the id to use
