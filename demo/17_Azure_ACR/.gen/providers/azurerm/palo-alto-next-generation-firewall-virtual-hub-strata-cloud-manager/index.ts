// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/palo_alto_next_generation_firewall_virtual_hub_strata_cloud_manager
...
export interface PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly dnsSettings?: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDnsSettings;
  /**
  * identity block
  *
  ...
  */
  readonly identity?: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerIdentity;
  /**
  ...
  */
  readonly networkProfile: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerTimeouts;
}
export interface PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatBackendConfig {
  /**
...
export class PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatBackendConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatBackendConfig | undefined {
  ...
  public set internalValue(value: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatBackendConfig | undefined) {
    if (value === undefined) {
...
export interface PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatFrontendConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/palo_alto_next_generation_firewall_virtual_hub_strata_cloud_manager#port PaloAltoNextGenerationFirewallVirtualHubStrataCloudManager#port}
  */
  readonly port: number;
...
export class PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatFrontendConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatFrontendConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._port !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatFrontendConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._port = undefined;
...
export interface PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNat {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/palo_alto_next_generation_firewall_virtual_hub_strata_cloud_manager#name PaloAltoNextGenerationFirewallVirtualHubStrataCloudManager#name}
  */
  readonly name: string;
  ...
  */
  readonly backendConfig?: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatBackendConfig;
  /**
...
export function paloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatToHclTerraform(struct?: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNat | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    backend_config: {
      value: paloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatBackendConfigToHclTerraform(struct!.backendConfig),
      isBlock: true,
      type: "list",
      storageClassType: "PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatBackendConfigList",
    },
    frontend_config: {
      value: paloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatFrontendConfigToHclTerraform(struct!.frontendConfig),
      isBlock: true,
      type: "list",
      storageClassType: "PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatFrontendConfigList",
    },
  };
...
export class PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _backendConfig = new PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatBackendConfigOutputReference(this, "backend_config");
  public get backendConfig() {
    return this._backendConfig;
  }
  public putBackendConfig(value: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatBackendConfig) {
  ...
  private _frontendConfig = new PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatFrontendConfigOutputReference(this, "frontend_config");
  public get frontendConfig() {
    return this._frontendConfig;
  }
  public putFrontendConfig(value: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatFrontendConfig) {
...
export class PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatOutputReference {
    return new PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDnsSettings {
  /**
...
export class PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDnsSettingsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDnsSettings | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDnsSettings | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerIdentity {
  /**
...
export class PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerIdentityOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerIdentity | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerIdentity | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile {
  /**
...
export class PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfileOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerTimeouts {
  /**
...
export class PaloAltoNextGenerationFirewallVirtualHubStrataCloudManager extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_palo_alto_next_generation_firewall_virtual_hub_strata_cloud_manager";
  ...
  * @param importFromId The id of the existing PaloAltoNextGenerationFirewallVirtualHubStrataCloudManager that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/palo_alto_next_generation_firewall_virtual_hub_strata_cloud_manager#import import section} in the documentation of this resource for the id to use
  ...
  * @param options PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerConfig
  */
  public constructor(scope: Construct, id: string, config: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerConfig) {
    super(scope, id, {
      terraformResourceType: 'azurerm_palo_alto_next_generation_firewall_virtual_hub_strata_cloud_manager',
  ...
  private _destinationNat = new PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatList(this, "destination_nat", false);
  ...
  private _dnsSettings = new PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDnsSettingsOutputReference(this, "dns_settings");
  public get dnsSettings() {
    return this._dnsSettings;
  }
  public putDnsSettings(value: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDnsSettings) {
  ...
  private _identity = new PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerIdentityOutputReference(this, "identity");
  public get identity() {
    return this._identity;
  }
  public putIdentity(value: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerIdentity) {
  ...
  private _networkProfile = new PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfileOutputReference(this, "network_profile");
  public get networkProfile() {
    return this._networkProfile;
  }
  public putNetworkProfile(value: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile) {
  ...
  private _timeouts = new PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: paloAltoNextGenerationFirewallVirtualHubStrataCloudManagerTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      dns_settings: {
        value: paloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDnsSettingsToHclTerraform(this._dnsSettings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDnsSettingsList",
      },
      identity: {
        value: paloAltoNextGenerationFirewallVirtualHubStrataCloudManagerIdentityToHclTerraform(this._identity.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerIdentityList",
      },
      network_profile: {
        value: paloAltoNextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfileToHclTerraform(this._networkProfile.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfileList",
      },
      timeouts: {
        value: paloAltoNextGenerationFirewallVirtualHubStrataCloudManagerTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerTimeouts",
      },
    };
