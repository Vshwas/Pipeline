// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/oracle_autonomous_database_clone_from_backup
...
export class DataAzurermOracleAutonomousDatabaseCloneFromBackup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermOracleAutonomousDatabaseCloneFromBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/oracle_autonomous_database_clone_from_backup#import import section} in the documentation of this resource for the id to use
