...
export class MssqlManagedInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MssqlManagedInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/mssql_managed_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  // proxy_override - computed: true, optional: true, required: false
