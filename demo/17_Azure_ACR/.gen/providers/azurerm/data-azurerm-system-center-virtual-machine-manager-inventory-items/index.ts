// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/system_center_virtual_machine_manager_inventory_items
...
export class DataAzurermSystemCenterVirtualMachineManagerInventoryItems extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermSystemCenterVirtualMachineManagerInventoryItems that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/system_center_virtual_machine_manager_inventory_items#import import section} in the documentation of this resource for the id to use
