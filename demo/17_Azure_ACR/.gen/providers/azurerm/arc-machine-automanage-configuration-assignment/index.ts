// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/arc_machine_automanage_configuration_assignment
...
export class ArcMachineAutomanageConfigurationAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ArcMachineAutomanageConfigurationAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/arc_machine_automanage_configuration_assignment#import import section} in the documentation of this resource for the id to use
