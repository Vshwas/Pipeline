// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/cosmosdb_sql_role_definition
...
export class DataAzurermCosmosdbSqlRoleDefinition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermCosmosdbSqlRoleDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/cosmosdb_sql_role_definition#import import section} in the documentation of this resource for the id to use
