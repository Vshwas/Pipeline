// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/data_factory_linked_service_azure_blob_storage
...
export function dataFactoryLinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKeyToTerraform(struct?: DataFactoryLinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKeyOutputReference | DataFactoryLinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKey): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataFactoryLinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKeyToHclTerraform(struct?: DataFactoryLinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKeyOutputReference | DataFactoryLinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKey): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataFactoryLinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKeyOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataFactoryLinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKey | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._linkedServiceName !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: DataFactoryLinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKey | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._linkedServiceName = undefined;
      this._secretName = undefined;
...
export class DataFactoryLinkedServiceAzureBlobStorage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataFactoryLinkedServiceAzureBlobStorage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/data_factory_linked_service_azure_blob_storage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  public get sasTokenLinkedKeyVaultKey() {
    return this._sasTokenLinkedKeyVaultKey;
  }
  public putSasTokenLinkedKeyVaultKey(value: DataFactoryLinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKey) {
    this._sasTokenLinkedKeyVaultKey.internalValue = value;
  }
  public resetSasTokenLinkedKeyVaultKey() {
    this._sasTokenLinkedKeyVaultKey.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get sasTokenLinkedKeyVaultKeyInput() {
    return this._sasTokenLinkedKeyVaultKey.internalValue;
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sas_token_linked_key_vault_key: {
        ...
        isBlock: true,
        type: "list",
        storageClassType: "DataFactoryLinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKeyList",
      },
