// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/oracle_adbs_national_character_sets
...
export class DataAzurermOracleAdbsNationalCharacterSetsCharacterSetsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermOracleAdbsNationalCharacterSetsCharacterSets | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermOracleAdbsNationalCharacterSetsCharacterSets | undefined) {
    if (value === undefined) {
...
export class DataAzurermOracleAdbsNationalCharacterSetsCharacterSetsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAzurermOracleAdbsNationalCharacterSetsCharacterSetsOutputReference {
    return new DataAzurermOracleAdbsNationalCharacterSetsCharacterSetsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAzurermOracleAdbsNationalCharacterSets extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_oracle_adbs_national_character_sets";
  ...
  * @param importFromId The id of the existing DataAzurermOracleAdbsNationalCharacterSets that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/oracle_adbs_national_character_sets#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAzurermOracleAdbsNationalCharacterSetsConfig) {
    super(scope, id, {
  ...
  private _characterSets = new DataAzurermOracleAdbsNationalCharacterSetsCharacterSetsList(this, "character_sets", false);
  ...
  private _timeouts = new DataAzurermOracleAdbsNationalCharacterSetsTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermOracleAdbsNationalCharacterSetsTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: dataAzurermOracleAdbsNationalCharacterSetsTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataAzurermOracleAdbsNationalCharacterSetsTimeouts",
      },
    };
