// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/servicebus_namespace_disaster_recovery_config
...
export class ServicebusNamespaceDisasterRecoveryConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicebusNamespaceDisasterRecoveryConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/servicebus_namespace_disaster_recovery_config#import import section} in the documentation of this resource for the id to use
