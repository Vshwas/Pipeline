// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/log_analytics_workspace
...
export class DataAzurermLogAnalyticsWorkspace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermLogAnalyticsWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/log_analytics_workspace#import import section} in the documentation of this resource for the id to use
