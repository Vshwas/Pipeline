...
export class AutomationRunbook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutomationRunbook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/automation_runbook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      runtime_environment_name: cdktf.stringToTerraform(this._runtimeEnvironmentName),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      runtime_environment_name: {
        value: cdktf.stringToHclTerraform(this._runtimeEnvironmentName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
